document.addEventListener('DOMContentLoaded', function () {
    ...
    function calculateItemSubtotal(itemRow) {
      ...
      const unitPrice = parseFloat(itemRow.querySelector('.price').value) || 0;
      ...
      const tax = (amountAfterDiscount * taxPercentage) / 100;
    
      const subtotal = amountAfterDiscount + tax;
      return subtotal;
    }
    ...
    function addNewItem() {
      ...
      const inputs = newItemRow.querySelectorAll('input, textarea');
