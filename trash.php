            ...
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">
                  Overdue&nbsp;<span class='badge rounded-pill bg-danger'><div id="overdueCount"></div></span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
                  Partially Paid&nbsp;<span class='badge rounded-pill bg-grabber'><div id="partialCount"></div></span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
          ...
          <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#overdueCount').html(response.overdue);
                    $('#partialCount').html(response.partial);
                },
                error: function() {
                    $('#paidCount').html('Error fetching "paid" status count.');
                    $('#unpaidCount').html('Error fetching "unpaid" status count.');
                    $('#overdueCount').html('Error fetching "overdue" status count.');
                    $('#partialCount').html('Error fetching "partial" status count.');
                }
            });
        </script>
