        ...
        <div class="level-1-page p-4">
          <div class="level-2-tabs">
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="delete-invoice.php?invoice_number=<?php echo $invoice_number; ?>">
          ...
          <div class="level-2-page p-6">
            <div class="text-center fs-3 semibold py-5">
               

               <h2 class="fs">Delete this invoice</h1>
                <h2 class="fs-3 fw-light text-secondary">Invoice will be moved to the Trash, okay?</h2>
                    
                <div class="row my-5">
                    <div class="col">
                        <i class="far fa-file fa-4x"></i>
                        <i class="fa fa-arrow-right fa-2x mx-3" style="position: relative; top: -7px;"></i>
                        <i class="far fa-trash-alt fa-4x"></i>
                    </div>
                </div>
                
                <div>
                    <a class="btn btn-danger" rel="nofollow" data-method="delete" href="deleting-invoice.php?invoice_number=<?php echo $invoice_number; ?>">Delete Now</a>
                    <span class="mx-2">or</span>
                    <a class="underline text-secondary" href="dashboard.php">Cancel</a>
                </div>
