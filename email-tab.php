        ...
        <div class="level-1-page p-4">
          <div class="level-2-tabs">
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="email-tab.php?invoice_number=<?php echo $invoice_number; ?>">
               ...
               <div class="level-2-page p-4">
                        ...
                        <div class="px-5 py-3">
                            ...
                            <div class="px-lg-5">
                                ...
                                <form class="new_email" id="email-form" role="form" enctype="multipart/form-data" action="email_mailer.php" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="GuqKWQOgZf92ndJDJ4Qhs4PFyF9ltQ_UmtJn_26_76wPipbqWjlw-OPja3jac6o96VbG7mjzUxJUImgN1JI0kw" autocomplete="off" />
                    
                                    <div class="mb-2">
                                        <label for="email_from" class="form-label">From</label>
                                        <input type="email" class="form-control form-control-sm" id="email_from" placeholder="your_address@gmail.com" value="" required>
                                    </div>
                    
                                    <div class="mb-3">
                                        <label for="email_to" class="form-label">To</label>
                                        <input class="form-control form-control-sm" placeholder="first@customer.com, second@customer.com" maxlength="500" required="required" autocomplete="nope" role="presentation" size="500" type="text" name="email[to]" id="email_to" required/>
                                    </div>
                    
                                    <div class="mb-2 ms-1 form-check">
                                        <input name="email[send_me_copy]" type="hidden" value="0" autocomplete="off" /><input class="form-check-input" type="checkbox" value="1" checked="checked" name="email[send_me_copy]" id="email_send_me_copy" />
                                        <label class="form-check-label" for="email_send_me_copy">Send me a copy?</label>
                                    </div>
                    
                                    <div class="mb-3">
                                        <label for="email_subject" class="form-label">Subject</label>
                                        <input class="form-control form-control-sm" placeholder="" maxlength="500" size="500" type="text" value="Invoice #<?php echo htmlspecialchars($invoice_number); ?>" name="email[subject]" id="email_subject" required/>
                                    </div>
                    
                                    <div class="mb-3">
                                        <label for="email_body" class="form-label">Text</label>
                                        <textarea class="form-control form-control-sm" placeholder="" rows="10" maxlength="5000" name="email[body]" id="email_body" required>
Dear Customer,
...
If you need assistance or have any questions, please email: your_address@gmail.com</textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <input type="file" name="email[email_attachments_attributes][][file]" id="email_email_attachments_file_1" title="Attach File" class="form-control form-control-sm" multiple="multiple" data-buttonText="Attach File" />
                                    </div>
                    
                                    <div class="mb-3">
                                        <input type="file" name="email[email_attachments_attributes][][file]" id="email_email_attachments_file_2" title="Attach File" class="form-control form-control-sm" multiple="multiple" data-buttonText="Attach File" />
                                    </div>
                                ...
                                <script>
                                    function verifyCaptcha(e) {
                                        ...
                                        grecaptcha.enterprise.ready(function() {
                                            grecaptcha.enterprise.execute('6Lcs57gkAAAAAHMrbzp6CdgZtfZizW03UnSZpxyb', {action: 'email'}).then(function(token) {
                                                document.getElementById("recaptcha-token").value = token;
                                                $("#email-form").trigger('submit.rails');
                                            });
                                        });
                                    }
                                </script>
                                ...
                                <button type="submit" class="btn btn-primary w-100 ">Send E-mail</button>
